...
namespace Sackrany.Unit.Features.EffectsFeature
{
    [Serializable]
    public sealed class UnitEffectsController : ModuleController<UnitEffectBase, IUnitEffectTemplate>
    {        
        private readonly Dictionary<Type, List<Coroutine>> _effectCoroutines = new();
        
        protected override void AddedModulePostprocess(UnitEffectBase module)
        {
            module.IncreaseAmount(1);
        }
